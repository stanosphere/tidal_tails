...
for a in range (0,100):
	...
	f = 18 #'focal lengh' (distance of closst approach in case where M_p is small)
...
ax1.plot(ratio_array,tail_lengh)
ax1.set_xlabel("Ratio of Velocity to Parabolic Velocity")
ax1.set_ylabel("Tail Lengh")
ax1.set_title("Maximum Tail Lengh vs Ratio of Velocity to Parabolic Velocity")

fig, ax1 = plt.subplots()
ax1.plot(ratio_array,d_min)
ax1.set_xlabel("Ratio of Velocity to Parabolic Velocity")
ax1.set_ylabel("Distance of Closest Approach")
ax1.set_title("Distance of Closest Approach vs Ratio of Velocity to Parabolic Velocity")

print('The Distance of closest approach is: %s' %d_min)
print('The Maximum Tail Lengh is: %s' %tail_lengh)
print('The ratio is: %s' %ratio)
