...
for a in range(1,16):
	...
	h = 1 #h=0 for point mass @ centre, h=1 for dark matter halo.
	...
	f = 25 #'focal lengh' (distance of closst approach in case where M_p is small)
	y_p = 60 #initial y displacement of perturbing galaxy
	...
	N = array([2,3,4,5,6])*a #Choose number of particles in each ring
	...
	fig1 = plt.figure()
	ax1 = fig1.add_subplot(111, autoscale_on=False, xlim=(-30, 30), ylim=(-30, 30),
